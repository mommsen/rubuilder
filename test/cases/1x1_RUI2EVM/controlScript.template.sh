...
sendSimpleCmdToApp RU0_SOAP_HOST_NAME  RU0_SOAP_PORT rubuilder::rui::Application 1 Configure
...
#Start generation of dummy triggers
...
sendSimpleCmdToApp RU0_SOAP_HOST_NAME RU0_SOAP_PORT  rubuilder::rui::Application 1 Enable
...
state=`getParam EVM0_SOAP_HOST_NAME EVM0_SOAP_PORT rubuilder::rui::Application 0 stateName xsd:string`
...
state=`getParam RU0_SOAP_HOST_NAME RU0_SOAP_PORT rubuilder::rui::Application 1 stateName xsd:string`
