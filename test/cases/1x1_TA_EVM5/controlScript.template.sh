...
sendSimpleCmdToApp EVM0_SOAP_HOST_NAME EVM0_SOAP_PORT rubuilder::evm::Application 5 Configure
...
#Enable EVM
sendSimpleCmdToApp EVM0_SOAP_HOST_NAME EVM0_SOAP_PORT rubuilder::evm::Application 5 Enable
...
state=`getParam EVM0_SOAP_HOST_NAME EVM0_SOAP_PORT rubuilder::evm::Application 5 stateName xsd:string`
...
evmInstance=`getParam EVM0_SOAP_HOST_NAME EVM0_SOAP_PORT rubuilder::ta::Application 0 evmInstance xsd:integer`
echo "TA0 evmInstance=$evmInstance"
if test $evmInstance -ne 5
then
  echo "Test failed"
  exit 1
fi

evmInstance=`getParam BU0_SOAP_HOST_NAME BU0_SOAP_PORT rubuilder::bu::Application 0 usedEvmInstance xsd:int`
echo "BU0 evmInstance=$evmInstance"
if test $evmInstance -ne 5
then
  echo "Test failed"
  exit 1
