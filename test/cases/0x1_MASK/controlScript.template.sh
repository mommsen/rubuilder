...
echo "Set rubuilder::ru::Application mask: No RUs"
sendCmdToApp EVM0_SOAP_HOST_NAME EVM0_SOAP_PORT rubuilder::evm::Application 0 setEvm_NoRus.cmd.xml
sendCmdToApp BU0_SOAP_HOST_NAME  BU0_SOAP_PORT rubuilder::bu::Application  0 setBu__NoRus.cmd.xml
