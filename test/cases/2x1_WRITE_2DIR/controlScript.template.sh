...
setParam BU0_SOAP_HOST_NAME BU0_SOAP_PORT rubuilder::bu::Application 0 rawDataDir string $testDir/raw
setParam BU0_SOAP_HOST_NAME BU0_SOAP_PORT rubuilder::bu::Application 0 metaDataDir string $testDir/meta
...
ls -l $testDir/raw/BU-000/run$runNumber

if test -x $testDir/raw/BU-000/run$runNumber/open
then
    echo "Test failed: $testDir/raw/BU-000/run$runNumber/open exists"
    exit 1
fi

ls -l $testDir/meta/BU-000/run$runNumber

if test ! -s $testDir/meta/BU-000/run$runNumber/EoLS_0001.jsn
then
    echo "Test failed: $testDir/meta/BU-000/run$runNumber/EoLS_0001.jsn does not exist"
    exit 1
fi

if test ! -s $testDir/meta/BU-000/run$runNumber/EoR_$runNumber.jsn
then
    echo "Test failed: $testDir/meta/BU-000/run$runNumber/EoR_$runNumber.jsn does not exist"
    exit 1
fi
