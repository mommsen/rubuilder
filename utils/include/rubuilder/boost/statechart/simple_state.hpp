...
#include <rubuilder/boost/statechart/detail/memory.hpp>
...
#include <rubuilder/boost/mpl/plus.hpp>
#include <rubuilder/boost/mpl/max_element.hpp>
#include <rubuilder/boost/mpl/greater.hpp>
